import{s as $,a as I,d as x,b as B,T as P,c as R,e as D,Q as F,i as w,f as b}from"./index-D5rnC_2S.js";let l=null,r=null,g=null,T=null,p=!1;const f={mushaf:null,tafsir:null},a={mushaf:{title:"وضع التدبّر",desc:"صفحات المصحف الكاملة وخطوطه.",sizeMb:F,startDownload:()=>D(),deleteCache:()=>R()},tafsir:{title:"وضع التفسير",desc:'سبعة تفاسير كاملة + ملخّص "مختصر التفاسير" لكل آية.',sizeMb:P,startDownload:()=>B(),deleteCache:()=>x()}};function N(){if(document.getElementById("offlinePanelFont"))return;const e=document.createElement("link");e.id="offlinePanelFont",e.rel="stylesheet",e.href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Arabic:wght@400;500;600;700&display=swap",document.head.appendChild(e)}function L(e){return`≈ ${e} ميجابايت`}function z(e,o){const i=a[e],n=o?.status||"idle";if(f[e]==="delete"&&(n==="done"||n==="idle"))return`
